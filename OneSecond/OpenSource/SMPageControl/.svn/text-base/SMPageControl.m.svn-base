...
//	self.accessibilityPageControl = [[[UIPageControl alloc] init] autorelease];
    self.accessibilityPageControl = [[UIPageControl alloc] init];
//    self.accessibilityPageControl.pageIndicatorTintColor = [UIColor clearColor];
//    self.accessibilityPageControl.currentPageIndicatorTintColor = [UIColor clearColor];
}
