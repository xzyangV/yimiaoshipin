...
- (void)layoutSubviews {
    ...
    CGSize labelSize = [PublicObject sizeForString:label.text font:label.font];//[label.text sizeWithFont:label.font];
...
//	CGSize maxSize = CGSizeMake(maxWidth, remainingHeight);
    CGSize detailsLabelSize = [PublicObject sizeForString:detailsLabel.text font:detailsLabel.font model:detailsLabel.lineBreakMode];
    if (detailsLabelSize.height > remainingHeight) {
        detailsLabelSize.height = remainingHeight;
    }
    if (detailsLabelSize.width > maxWidth) {
        detailsLabelSize.width = maxWidth;
    }
