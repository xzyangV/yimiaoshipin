...
- (id)initWithFrame:(CGRect)frame type:(RMIndicatorType)type lineWidth:(CGFloat)lineWidth
{
    self = [super initWithFrame:frame];
    if (self) {
        // Initialization code
...
- (void)initAttributes
{
    ...
    if(_type == kRMClosedIndicator)
    {
        ...
        _closedIndicatorBackgroundStrokeColor = ColorForHex(0xf2f2f2);
//        _coverWidth = 3;
...
- (void)addDisplayLabel
{
    ...
    self.displayLabel.textColor = ColorForHex(0xf2f2f2);
