...
- (id)initWithVertexShaderFromString:(NSString *)vertexShaderString fragmentShaderFromString:(NSString *)fragmentShaderString;
{
    ...
    FiveFrameWasVideo = NO;
    fiveFrameCheckDisabled = NO;
    ...
    runSynchronouslyOnVideoProcessingQueue(^{
        ...
        glEnableVertexAttribArray(filterFiveTextureCoordinateAttribute);
    });
...
- (void)newFrameReadyAtTime:(CMTime)frameTime atIndex:(NSInteger)textureIndex;
{
    ...
    if (hasReceivedFirstFrame && hasReceivedSecondFrame && hasReceivedThirdFrame && hasReceivedFourFrame && hasReceivedFiveFrame)
    {
        return;
    }
    ...
    if ((hasReceivedFirstFrame && hasReceivedSecondFrame && hasReceivedThirdFrame && hasReceivedFourFrame && hasReceivedFiveFrame) || updatedMovieFrameOppositeStillImage)
    {
